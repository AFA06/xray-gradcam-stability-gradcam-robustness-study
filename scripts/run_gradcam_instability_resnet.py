...
SAVE_DIR = "/home/azureuser/chexpert/gradcam_results/phase3_resnet_instability"
CLASS_IDX = 0  # change class if needed
...
# ------------------------------
# Choose correct ResNet target layer
# ------------------------------
...
# ------------------------------
# Generate Grad-CAM for each variant
# ------------------------------
cams = {}
...
print("\nAll Grad-CAM variants generated.")
